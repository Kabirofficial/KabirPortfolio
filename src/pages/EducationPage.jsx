  ...
  return (
    <div className="py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl md:text-5xl font-extrabold text-[#000000] text-center mb-12">Education</h1>
        <div className="relative border-l-2 border-[#8FABD4] pl-8 space-y-12">
          {education.map((item, index) => (
            <div key={index} className="relative">
              ...
              <h3 className="text-2xl font-bold text-[#000000] mt-1">{item.degree}</h3>
              <h4 className="text-xl font-medium text-[#000000]/70 mb-2">{item.institution}</h4>
