        ...
        <div className="min-h-screen flex flex-col bg-transparent overflow-hidden relative">
            ...
            <div className="flex-1 flex flex-col justify-center items-center relative p-6 md:p-12 z-10 w-full overflow-hidden">
                <motion.div
                    ...
                    className="text-center flex flex-col items-center max-w-2xl w-full relative z-20"
                >
                ...
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-[30vw] font-bold tracking-tighter leading-none opacity-[0.01] dark:opacity-[0.015] pointer-events-none select-none z-0 uppercase font-mono">
                    404
                </div>
            </div>
        </div>
